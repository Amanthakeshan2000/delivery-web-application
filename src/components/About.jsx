    ...
    <div className="min-h-screen flex flex-col lg:flex-row justify-center items-center lg:px-32 px-5 py-10 bg-gray-100">
      ...
      <div className="lg:w-2/3 flex flex-col space-y-6 lg:space-y-8 text-center lg:text-left">
        ...
        <p className="text-lg text-gray-700">
          Our Crab dishes are prepared using the finest Sri Lankan spices and a special recipe developed by our executive Chef Raj and Chef Dinushka. 
          Serendib Restaurant is where you can enjoy the finest Crab dishes in Malaysia.
        </p>
        <p className="text-lg text-gray-700">
